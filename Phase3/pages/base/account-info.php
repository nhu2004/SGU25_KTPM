...
/* ƯU TIÊN SĐT Ở BẢNG customer, nếu không có thì lấy account_phone */
$phone = $row['customer_phone'] ?? '';
if ($phone === '' && !empty($row['account_phone'])) {
    ...
    <div class="container">
        ...
        <div class="account-info__box">
            ...
            <div class="account-info__row d-flex justify-end">
                <a class="h6 account-info__edit" href="index.php?page=my_account&tab=account_settings">
                 Thay đổi thông tin
                </a>
            </div>
        </div>
