  ...
  <div class="header__topbar">
    <div class="container p-relative d-flex space-between align-center">
      ...
      <?php if (isset($_SESSION['account_email'])) { ?>
        <span class="h5 login-btn p-absolute">Tài khoản</span>
      <?php } else { ?>
        <span class="h5 login-btn p-absolute">Đăng nhập</span>
      <?php } ?>
    </div>
  </div>
      ...
      <div class="header__container d-grid middle-left">
        ...
        <div class="header__action d-flex align-center">
          ...
          <div class="header__action--item d-flex align-center p-relative">
            <!-- DÙNG GET để không bị Resubmit form -->
            <form action="index.php" method="GET" class="d-flex align-center" id="search-box">
              <!-- page=search để router trong main.php nhận được -->
          ...
          <div class="header__action--item d-flex align-center">
            <span class="h7 text-muted">Giỏ hàng</span>
          </div>
        </div>
      </div>
    </div>
