...
// Bật buffer (tuỳ chọn nhưng an toàn khi bạn chưa soát hết các include)
ob_start();

// Mở session thật sớm
session_name('guha'); // tên tuỳ chọn
session_start();

// Include PHP trước khi in ra HTML
require_once __DIR__ . '/admin/format/format.php';
require_once __DIR__ . '/admin/config/config.php';
// Có thể hoãn include main cho đến trong body (tuỳ bạn), nhưng đừng output trước.
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body>
  <div id="wrapper">
    <?php
      // include nội dung động tại đây nếu cần
