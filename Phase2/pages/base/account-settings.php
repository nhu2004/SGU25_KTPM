...
// Lấy account_id từ session, nếu không có thì bắt login lại
...
// Lấy thông tin customer theo account_id
        ...
        <div class="checkout__infomation">
            ...
            ?>
                <div class="info__item d-flex">
                    ...
                    <input class="info__content flex-1" name="customer_name" value="<?php echo htmlspecialchars($account['customer_name']); ?>">
                </div>
                <div class="info__item d-flex">
                    <label class="info__title" for="">Email:</label>
                    <input class="info__content flex-1" name="customer_email" value="<?php echo htmlspecialchars($account['customer_email']); ?>" disabled>
                </div>
                <div class="info__item d-flex">
                    <label class="info__title" for="">Số điện thoại:</label>
                    <input class="info__content flex-1" name="customer_phone" value="<?php echo htmlspecialchars($account['customer_phone']); ?>">
                </div>
                <div class="info__item d-flex">
                    <label class="info__title" for="">Địa chỉ:</label>
                    <input class="info__content flex-1" name="customer_address" value="<?php echo htmlspecialchars($account['customer_address']); ?>">
                </div>
                <div class="info__item d-flex">
                    <label class="info__title" for="">Giới tính:</label>
                    <div class="gender-details">
                        <input type="radio" name="customer_gender" value="0" id="dot-1" <?php if ($account['customer_gender'] == 0) { echo "checked"; } ?>>
                        <label for="dot-1">Không xác định</label>

                        <input type="radio" name="customer_gender" value="1" id="dot-2" <?php if ($account['customer_gender'] == 1) { echo "checked"; } ?>>
                        <label for="dot-2">Nam</label>

                        <input type="radio" name="customer_gender" value="2" id="dot-3" <?php if ($account['customer_gender'] == 2) { echo "checked"; } ?>>
