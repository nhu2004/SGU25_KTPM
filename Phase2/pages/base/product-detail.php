                ...
                <div class="row">
                        ...
                        <div class="product-detail__media">
                            <div class="media__items d-flex">
                                <div class="media__item product-image-container w-100">
                                    <?php $imgMain = img_url_phase1($row_product_detail['product_image'] ?? null); ?>
                                    <img class="w-100" src="<?php echo htmlspecialchars($imgMain); ?>" alt="image product" />
                    ...
                    <div class="col" style="--w-md: 6">
                        <div class="product-detail__info">
                            <!-- ✅ Đổi action: post đến addtocart.php và truyền product_id qua query string -->
                            <form method="POST" action="pages/handle/addtocart.php?product_id=<?= (int)$row_product_detail['product_id'] ?>">
                                <span class="h6">Mã sản phẩm: <?php echo (int)$row_product_detail['product_id'] ?></span>
                                <h1 class="product-detail__name"><?php echo htmlspecialchars($row_product_detail['product_name']) ?></h1>
                                <span class="review-star-list d-flex align-center">
                                    <?php for ($i = 0; $i < 5; $i++) {
                                        echo '<div class="rating-star'.(($i + 1 <= $rate_avg)? '':' rating-off').'"></div>';
                                    } ?>
                                </span>
                                <div class="product-detail__price d-flex align-center">
                                    <?php if ((int)$row_product_detail['product_sale'] > 0) { ?>
                                        <del class="product__price--old h5"><?php echo number_format((int)$row_product_detail['product_price']) . ' ₫' ?></del>
                                    <?php } ?>
                                    <?php
                                    $sale=(int)$row_product_detail['product_sale'];
                                    $pOld=(int)$row_product_detail['product_price'];
                                    $pNew=$sale>0?($pOld-($pOld*$sale/100)):$pOld;
                                    ?>
                                    <span class="product__price--new h4"><?php echo number_format($pNew) ?> ₫</span>
                                    <?php if ($sale > 0) { ?>
                                        <span class="product__sale h6"> - <?php echo $sale ?>%</span>
                                    <?php } ?>
                                </div>
                                <div class="product-detail__variants">
                                    <div class="product-detail__variant">
                                        <h3 class="product-detail__variant--title h6">Dung tích</h3>
                                        <div class="product-detail__variant--items d-flex">
                                            <input class="custom-radio" type="radio" name="size" id="size1" checked="checked" />
                                            <label class="custom-label product-detail__variant--item" for="size1">
                                                <?php echo htmlspecialchars($row_product_detail['capacity_name']) ?>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-detail__quantity">
                                    ...
                                    <div class="d-flex align-center">
                                        <div class="select__number p-relative">
                                            <button type="button" class="select__number--minus cursor-pointer p-absolute" onclick="chgQty(-1)">
                                                <img src="./assets/images/icon/minus.svg" alt="sub" />
                                            </button>
                                            <!-- name="product_quantity" sẽ post về handler -->
                                            <input id="qty" type="number" name="product_quantity" min="1" value="1" class="select__number--value heading-6 w-100 h-100" />
                                            <button type="button" class="select__number--plus cursor-pointer p-absolute" onclick="chgQty(1)">
                                                <img src="./assets/images/icon/plus.svg" alt="sum" />
                                            </button>
                                        </div>
                                        <span class="h6" style="margin-left: 10px;">
                                            <?php if ((int)$row_product_detail['product_quantity'] > 0) { ?>
                                                còn <span class="quantity-total"> <?php echo (int)$row_product_detail['product_quantity'] ?> </span> sản phẩm
                                            <?php } else { ?>
                                ...
                                <?php if ((int)$row_product_detail['product_quantity'] > 0) { ?>
                                    <!-- ✅ Bật 2 nút submit đúng theo handler hiện tại -->
                                    <button class="btn product-detail__addtocart w-100" type="submit" name="addtocart">Thêm giỏ hàng</button>
                                    <button class="btn product-detail__buynow  w-100" type="submit" name="buynow">Mua ngay</button>
                                <?php } else { ?>
                            ...
                            <div class="describe__item describe__item--share">
                                <a class="product-detail__anchor" href="#">
                                    <ul class="social__items d-flex align-center">
                                        <li class="social__item"><h3 class="h5">Share:</h3></li>
                                        <li class="social__item opacity-50"><a href="#info-product"><img class="svg__icon d-block" src="./assets/images/icon/facebook.svg" alt="" /></a></li>
                                        <li class="social__item opacity-50"><a href="#"><img class="svg__icon d-block" src="./assets/images/icon/twitter.svg" alt="" /></a></li>
                                        <li class="social__item opacity-50"><a href="#"><img class="svg__icon d-block" src="./assets/images/icon/instagram.svg" alt="" /></a></li>
                                    </ul>
                                </a>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="tab__items d-flex">
                <div class="tabs d-flex p-relative">
                    <div class="pd-inline"><div class="tab-item active"><h3 class="h3">Thông tin sản phẩm</h3></div></div>
                    <div class="pd-inline"><div class="tab-item"><h3 class="h3">Đánh giá sản phẩm</h3></div></div>
                    <div class="line"></div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="tab-pane">
                    <div class="evaluate__rating d-flex align-center">
                        ...
                        <div class="rating-percent flex-1">
                            <div class="product-review-item d-flex align-center">
                                ...
                                <div class="product-bar"><div class="product-result" style="width: <?php echo $percent5 ?>%;"></div></div>
                            </div>
                            <div class="product-review-item d-flex align-center">
                                <div class="product-star d-flex align-center">
                                    <div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div>
                                </div><span class="sum-review"> (<?php echo $rate4 ?>) </span>
                                <div class="product-bar"><div class="product-result" style="width: <?php echo $percent4 ?>%;"></div></div>
                            </div>
                            <div class="product-review-item d-flex align-center">
                                <div class="product-star d-flex align-center">
                                    <div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div>
                                </div><span class="sum-review"> (<?php echo $rate3 ?>) </span>
                                <div class="product-bar"><div class="product-result" style="width: <?php echo $percent3 ?>%;"></div></div>
                            </div>
                            <div class="product-review-item d-flex align-center">
                                <div class="product-star d-flex align-center">
                                    <div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div>
                                </div><span class="sum-review"> (<?php echo $rate2 ?>) </span>
                                <div class="product-bar"><div class="product-result" style="width: <?php echo $percent2 ?>%;"></div></div>
                            </div>
                            <div class="product-review-item d-flex align-center">
                                <div class="product-star d-flex align-center">
                                    <div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div><div class="rating-star"></div>
                                </div><span class="sum-review"> (<?php echo $rate1 ?>) </span>
                                <div class="product-bar"><div class="product-result" style="width: <?php echo $percent1 ?>%;"></div></div>
                            </div>
                        </div>
                    ...
                    <div class="comment-form">
                        <form class="post-comment" method="POST" action="pages/handle/evaluate_rating.php?product_id=<?php echo (int)$product_id; ?>">
                    ...
                    <div class="evaluate__content">
                        <?php while ($evaluate = mysqli_fetch_array($query_evaluate)) { ?>
                            <div class="comment-item d-flex">
                                <div class="f-cmuser"><abbr title="<?php echo htmlspecialchars($evaluate['account_name']); ?>"><?php echo substr($evaluate['account_name'], 0, 1) ?></abbr></div>
                                <div class="cmuser-content d-flex flex-column">
                                    <span class="review-star-list d-flex">
                                        <?php for ($i = 0; $i < 5; $i++) {
                                            echo '<div class="rating-star'.($i < (int)$evaluate['evaluate_rate'] ? '' : ' rating-off').'"></div>';
                                        } ?>
                                    </span>
                                    <div class="customer__name">
                                        <strong class="evaluate_name"><?php echo htmlspecialchars($evaluate['account_name']) ?></strong>
                                        <span class="evaluate_date"><?php echo htmlspecialchars($evaluate['evaluate_date']) ?></span>
                                    </div>
                                    <div class="evaluate_content"><?php echo htmlspecialchars($evaluate['evaluate_content']) ?></div>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
...
<?php } // end while product_detail ?>

<script>
function chgQty(delta){
  const i = document.getElementById('qty');
  const cur = parseInt(i.value||'1',10);
...
<script>
    function showSuccessMessage() {
        toast({ title: "Success", message: "Thêm sản phẩm vào giỏ hàng thành công", type: "success", duration: 3000 });
    }
    function showErrorMessage() {
        toast({ title: "Error", message: "Không thể thêm sản phẩm vào trong giỏ hàng", type: "error", duration: 3000 });
    }
    function showAcceptMessage() {
        toast({ title: "Success", message: "Cập nhập thành công", type: "success", duration: 3000 });
    }
    function showWarningMessage() {
        toast({ title: "Warning", message: "Có gì đó không hợp lý đã xảy ra", type: "warning", duration: 3000 });
    }
</script>
<?php
if (isset($_GET['message'])) {
    $js = '';
    if ($_GET['message'] == 'success')      $js = 'showSuccessMessage();';
    elseif ($_GET['message'] == 'accept')   $js = 'showAcceptMessage();';
    elseif ($_GET['message'] == 'warning')  $js = 'showWarningMessage();';
    elseif ($_GET['message'] == 'error')    $js = 'showErrorMessage();';
    if ($js) {
        echo '<script>'.$js.'window.history.pushState(null,"","index.php?page=product_detail&product_id='.(int)$product_id.'");</script>';
    }
}
?>
<script>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        container.addEventListener("mouseover", function() { zoomWindow.style.display = "block"; });
        container.addEventListener("mouseout",  function() { zoomWindow.style.display = "none";  });
