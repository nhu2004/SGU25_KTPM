...
/**
 * Helper: lấy URL ảnh sản phẩm từ Phase 1 (cổng 8080)
 */
if (!function_exists('img_url_phase1')) {
    function img_url_phase1($file) {
        $file = trim((string)$file);
        if ($file === '') return './assets/images/no-image.png';
                                ...
                                <div class="cart__quantity">
                                    <div class="cart__quantity--container d-flex align-center">
                                        <div class="select__number p-relative">
                                            ...
                                            <!-- INPUT: cập nhật số lượng bằng tay -->
                                            <input
                                                type="number"
                                                min="0"
                                ...
                                <div class="cart__quantity">
                                    <div class="cart__quantity--container d-flex align-center">
                                        <div class="select__number p-relative">
                                            ...
                                            <!-- INPUT: vẫn cho phép sửa, validate ở server -->
                                            <input
                                                type="number"
                                                min="0"
                                                value="<?php echo $qtyLine; ?>"
...
<script>
    ...
    function showErrorMessage() {
        toast({
            title: "Error",
            // dùng chung cho case vượt tồn kho / số không hợp lệ
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        inputs.forEach(function (input) {
            input.addEventListener("change", function () {
                ...
                if (isNaN(qty) || qty < 0) {
                    qty = 0; // server sẽ xử lý 0 = xóa
                }

                // Điều hướng sang handler update quantity
