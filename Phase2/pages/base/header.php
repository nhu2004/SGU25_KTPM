...
if (session_status() === PHP_SESSION_NONE) {
    session_name('guha'); // nếu index.php đã set rồi thì dòng này vẫn ok
    session_start();
}
...
$isLoggedIn = !empty($_SESSION['account_email']) || !empty($_SESSION['account_id']);
            ...
            <div class="header__container d-grid middle-left">
                ...
                <nav class="header__nav space-between d-flex">
                    ...
                    <div class="header__footer md-none">
                        ...
                        <ul class="social__items d-flex align-center">
                            <li class="social__item"><a class="" href="#"><img class="svg__icon d-block" src="./assets/images/icon/twitter.svg" alt="" /></a></li>
                            <li class="social__item"><a class="" href="#"><img class="svg__icon d-block" src="./assets/images/icon/facebook.svg" alt="" /></a></li>
                            <li class="social__item"><a class="" href="#"><img class="svg__icon d-block" src="./assets/images/icon/instagram.svg" alt="" /></a></li>
                            <li class="social__item"><a class="" href="#"><img class="svg__icon d-block" src="./assets/images/icon/tiktok.svg" alt="" /></a></li>
                            <li class="social__item"><a class="" href="#"><img class="svg__icon d-block" src="./assets/images/icon/youtube.svg" alt="" /></a></li>
                        </ul>
                    </div>
                </nav>
                <div class="header__action d-flex align-center">
                    ...
                    <div class="header__action--item align-center d-none md-flex">
                        <a class="header__action--link d-inline-block" href="<?php echo $isLoggedIn ? "index.php?page=my_account&tab=account_info" : "index.php?page=login"; ?>">
