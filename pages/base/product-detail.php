                    ...
                    <div class="col" style="--w-md: 6">
                        <div class="product-detail__info">
                            <form method="POST" action="#">
                                ...
                                <?php if ((int)$row_product_detail['product_quantity'] > 0) { ?>
                                    <!-- Phase 1: disable hành động -->
                                    <button class="btn product-detail__addtocart w-100" type="button" disabled title="Sẽ mở ở Giai đoạn 2">Thêm giỏ hàng</button>
                                    <button class="btn product-detail__buynow  w-100" type="button" disabled title="Sẽ mở ở Giai đoạn 2">Mua ngay</button>
                                <?php } else { ?>
